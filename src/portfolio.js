...
const bigProjects = {
  ...
  projects: [
    ...
    },
    {
      ...
      projectDesc: "Hotel booking management website made using CSS, JavaScript, PHP, and MySQL. XAMPP was used as a local hosting platform.",
      footerLink: [
        {
          name: "Visit github page",
    ...
    },
    {
      ...
      projectDesc: "Basic traveling website for checking packages for traveling.",
      footerLink: [
        {
          name: "Visit github page",
